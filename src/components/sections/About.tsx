...
const About = () => (
  <Section id="about" header="About Me">
    <div className="flex flex-col gap-8">
      <BodyText>I craft seamless digital experiences as a <BoldText>full-stack software engineer</BoldText> with <BoldText>3 years of experience</BoldText>.</BodyText>
