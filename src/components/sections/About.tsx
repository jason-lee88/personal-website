...
const About = () => (
  <Section id="about" header="About Me">
    <div className="flex flex-col gap-8">
      ...
      <BodyText>I <BoldText>specialize in frontend development</BoldText>, having a natural inclination towards creating <BoldText>modern, intuitive, and performant user interfaces</BoldText>. I have experience creating and maintaining <BoldText>design systems</BoldText> from scratch. At work, I'm an expert of building end-to-end applications using <BoldText>React</BoldText>.</BodyText>
      <BodyText>While I'm not busy coding, I'm usually reading, enjoying board games with friends & family, or enjoying my favorite strategy and puzzle games (Modern Tetris, Chess, Teamfight Tactics, VALORANT).</BodyText>
    </div>
  </Section>
);
